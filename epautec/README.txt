...
a persistence unit "epautecPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "epautec/pom.xml":
...
artifact ("epautec.war") is already built. You can build
